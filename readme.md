...
- [Folder Organization aka NO Git Submodules](#folder-organization-aka-no-git-submodules)
    - [You are working with C# and liking VS Code (a lot)?](#you-are-working-with-c-and-liking-vs-code-a-lot)
  - [The Actual Usage](#the-actual-usage)
 ...
 **To re-use it, "git it out" (this repo) somewhere handy and reference `dbjcore.cs` in your solution project(s)**
...
# Folder Organization aka NO Git Submodules
